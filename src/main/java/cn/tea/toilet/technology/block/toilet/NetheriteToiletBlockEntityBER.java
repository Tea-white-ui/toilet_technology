...
/**
 * 下界合金马桶方块实体渲染器
 * 与 PremiumToiletBlockEntityBER 使用相同的渲染逻辑
 */
public class NetheriteToiletBlockEntityBER implements BlockEntityRenderer<NetheriteToiletBlockEntity> {

    public NetheriteToiletBlockEntityBER(BlockEntityRendererProvider.Context context) {
    }

    @Override
    public void render(@NotNull NetheriteToiletBlockEntity netheriteToiletBlockEntity, float partialTick, @NotNull PoseStack poseStack, @NotNull MultiBufferSource bufferSource, int packedLight, int packedOverlay) {
        FluidStack fluidStack = netheriteToiletBlockEntity.getFluid();
