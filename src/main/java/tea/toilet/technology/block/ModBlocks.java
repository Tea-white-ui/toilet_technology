...
public class ModBlocks {
    ...
    public static final Block FECES_BLOCK = registerBlock(
            ResourceKey.create(Registries.BLOCK, ResourceLocation.fromNamespaceAndPath("toilet_technology", "feces_block")),
            new Block(Block.Properties.of()
                    ...
                    // === 工具与挖掘 ===
                    // .requiresCorrectToolForDrops() // 需要正确工具才能掉落（配合tag定义工具等级）
            )
    );
